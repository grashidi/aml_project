...
if __name__ == "__main__":
    ...
    unet.load_state_dict(torch.load("with_ROI/unet_e10_bs16_09-09-2021_10:17:50.pt"))
    ...
    #train ...
    if not os.path.exists("with_ROI/model_backup/"):
        os.makedirs("with_ROI/model_backup/")
